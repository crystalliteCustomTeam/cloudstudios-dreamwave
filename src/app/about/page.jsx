...
const banner = {
    ...
    title: "Brands and businesses take the stratosphere route here – experience a full suite of video animation solutions geared to perfection with next-generation technology. ",
    txt: (
        <>
