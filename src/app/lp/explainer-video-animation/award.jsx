            ...
            <Container>
                <Row>
                    <Col lg={12} className={styles.awardContent}>
                        ...
                        <p>At Infinity Animations, we create powerful video animations that elevate your brand. Our dedication to excellence has earned us numerous awards and accolades, including:</p>
