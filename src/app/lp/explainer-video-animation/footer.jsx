                        ...
                        <Col md={6} lg={4} className="m-auto">
                            <div className={styles.footerContent}>
                                ...
                                <div className={styles.contactInfo}>
                                    <a href="tel:1-833-666-6689"><FooterPhone />1-833-666-6689</a>
                                </div>
                                <div className={styles.contactInfo}>
                                    <a href="mailto:queries@infinityanimations.com"> <FooterEmail />queries@infinityanimations.com</a>
                                </div>
                                <div className={styles.contactInfo}>
                                    <a href="www.infinityanimations.com"> <FooterWeb />www.infinityanimations.com</a>
                                </div>
                ...
                <Container className="h-100">
                    <Row className="h-100">
                        <Col md={6} className="my-auto">
                            <p>© Copyright 2024 - Infinity Animations</p>
                        </Col>
                        <Col md={6} className="my-auto">
                            <ul>
