            ...
            <Container>
                <Row>
                    <Col lg={8} className='m-auto text-center'>
                        ...
                        <p>Cloud Studios Inc is a renowned name in the video animation industry. Our packages cover all the pre-production and post-production steps so that you walk away with an animated video that delivers results.</p>
                    </Col>
                    <Col lg={12}>
                            ...
                            <div className={styles.priceItem} >
                                ...
                                <div className={styles.ctaBtn}>
                                    ...
                                    <div className={styles.contactItem}>
                                        <div>
                                            <a href="tel:1-833-666-6684"><PhoneICon />1-833-666-6684</a>
                                        </div>
                                        <div>
