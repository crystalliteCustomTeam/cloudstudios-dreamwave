            ...
            <Container>
                <Row>
                    <Col>
                        ...
                        <p>
                            YOU agree that Cloud Studios LLC is not liable for any correspondence from email address(es) other than the ones followed by our own domain i.e. "..@cloudstudiosllc.com" or/and any toll free number that is not mentioned on our website. Cloud Studios LLC should not be held responsible for any damage(s) caused by such correspondence. We only take responsibility of any communication through email address(es) under our own domain name or/and via toll free number i.e. already mentioned on Cloud Studios LLC Website.
                        </p>
                        <p>
